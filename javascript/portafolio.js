    ...
    if (e.target.classList.contains('img_trabajo')) {
        ...
        switch (e.target) {
            ...
            case div[1]:
                ...
                document.querySelector('.a_info').href = 'https://larezdeivys.github.io/Pagina-Empresarial-uno/'
                document.querySelector('.info_icono1').src = 'img/html5.png'
                document.querySelector('.info_icono2').src = 'img/javascript2.png'
                document.querySelector('.info_icono3').src = 'img/css.png'
                break;
            case div[2]:
                ...
                document.querySelector('.a_info').href = 'https://larezdeivys.github.io/Distribuidora-De-Alimentos/'
                document.querySelector('.info_icono1').src = 'img/html5.png'
                document.querySelector('.info_icono2').src = 'img/javascript2.png'
                document.querySelector('.info_icono3').src = 'img/css.png'
                break;
            case div[3]:
                ...
                document.querySelector('.a_info').href = 'https://larezdeivys.github.io/Restaurante-Italiano/'
                document.querySelector('.info_icono1').src = 'img/html5.png'
                document.querySelector('.info_icono2').src = 'img/javascript2.png'
                document.querySelector('.info_icono3').src = 'img/css.png'
                break;
            case div[4]:
                ...
                document.querySelector('.a_info').href = 'https://larezdeivys.github.io/Calculadora-basica/'
                document.querySelector('.info_icono1').src = 'img/html5.png'
                document.querySelector('.info_icono2').src = 'img/javascript2.png'
                document.querySelector('.info_icono3').src = 'img/css.png'
                break;
            case div[5]:
                ...
                document.querySelector('.a_info').href = 'https://larezdeivys.github.io/Pagina-Empresarial-dos/'
                document.querySelector('.info_icono1').src = 'img/html5.png'
                document.querySelector('.info_icono2').src = 'img/javascript2.png'
                document.querySelector('.info_icono3').src = 'img/css.png'
                break;
            case div[6]:
                ...
                document.querySelector('.a_info').href = 'https://larezdeivys.github.io/Lugares-de-Venezuela/'
                document.querySelector('.info_icono1').src = 'img/html5.png'
                document.querySelector('.info_icono2').src = 'img/javascript2.png'
                document.querySelector('.info_icono3').src = 'img/css.png'
                break;
